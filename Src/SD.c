#include "sd.h"
#include "fatfs.h"
// define SMD for SD card (SPI MODE)	----------------------------------- 0x40 la ma bat buoc khi goi lenh "Start bit + transmission bit + 6 bit mã lenh"  01xxxxxx
...
uint8_t SD_Write_Block (uint8_t *buff, uint32_t lba)
{
  ...
  SPI_Release();
  SPI_SendByte (0xFE); // 0xFE này là data token, báo cho card mcu san sàng
